...
@WebServlet(urlPatterns = "/update2PlayServlet")
public class update2PlayServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            System.out.println(request.getParameter("play_id"));
            play.setPlay_id(Integer.parseInt(request.getParameter("play_id")));
